...
from .utils import get_buildings_with_size, buildings_fuzzy_sort


class BuildingSelectionWindow:
    on_building_selected: Callable[[Type[Building]], None]
    ...
    def on_entry_text_change(self, *args):
        ...
        buildings_fuzzy_sort(text, self.buildings)
    ...
    def select_building(self, *args):
        ...
        self.on_building_selected(
            self.buildings[self.listbox.curselection()[0]]
        )
