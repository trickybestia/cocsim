...
class BuildersHutModel(BaseModel):
    name: Literal["BuildersHut"]
    x: int
    y: int
    level: int
...
class BuildersHut(PassiveBuilding):
    ...
    @classmethod
    def model(cls) -> Type[BuildersHutModel]:
        return BuildersHutModel
    ...
    @classmethod
    def from_model(
        cls, game: "game.Game", model: BuildersHutModel
    ) -> "BuildersHut":
